// ================================
// FRONTEND - Interview Skills Selector
// ================================
// File: src/pages/InterviewPrep.jsx
...
const InterviewPrep = () => {
  ...
  const [skillFilter, setSkillFilter] = useState('all'); // all, technical, soft
  const [loading, setLoading] = useState(true);
  const [generatingQuestions, setGeneratingQuestions] = useState(false);
  const [showQuestions, setShowQuestions] = useState(false);
  const [sessionId, setSessionId] = useState(null);

  // Fetch user's resume analyses and extract skills
  useEffect(() => {
  ...
  const fetchAnalysesAndExtractSkills = async () => {
    ...
    try {
      ...
      // Extract and consolidate all skills
  ...
  // Generate interview questions based on selected skills
  ...
  // Get skill frequency from analyses
